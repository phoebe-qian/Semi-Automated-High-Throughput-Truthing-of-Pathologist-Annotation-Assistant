...
def get_image_info_cell(image_name):
    th = 0.85
    number_of_patches = 8
    show_gray = 0
    max_num_cells = 400
...
def get_image_info(image_name):
    ...
    if image_name == "Water":
        ...
        path = dir+"Crabs.png"
        im_size = [400,700] # height,width
        #window_loc = [[578,351]]
        window_loc = [[587,352]] #col, row locations
        gt_color = [0, 0, 0]
        patch_sz = 31
    ...
    return [im_size,number_of_patches,th,path,show_gray,max_num_cells,gt_color,patch_sz,dir]
